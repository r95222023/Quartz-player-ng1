(function () {
    ...
    PRESETS.ng1={
        js: [
            ...
            'https://cdnjs.cloudflare.com/ajax/libs/angulartics/1.2.1/angulartics.min.js',
            'https://cdnjs.cloudflare.com/ajax/libs/angulartics-google-analytics/0.2.1/angulartics-ga.min.js',
    ...
    PRESETS.ngMaterial = {
        ...
        css:['https://ajax.googleapis.com/ajax/libs/angular_material/1.1.1/angular-material.min.css',
